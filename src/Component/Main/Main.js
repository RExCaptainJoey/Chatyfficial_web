...
import ic_default_avatar from "../../images/ic_default_avatar.png";
                ...
                <span className="textItem">{`Name: ${
                    item.data().nickname
                                ...
                                <span className="textItem">{`About : ${
                                    item.data().aboutMe ? item.data().aboutMe : 'Nothing to see here.'
                                    }`}</span>
                            </div>
                        </button>
                    )
        ...
        return (
            <div>
                <div className="viewWrapTextDialogConfirmLogout">
                    <span className="titleDialogConfirmLogout">Are you sure you want to logout?</span>
                </div>
